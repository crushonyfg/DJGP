        ...
        if use_lmjgp:
            ...
            for K in [2, 3, 5, 7]:
                ...
                for lr in [0.1]:
                    ...
                    from DJGP_test_validation import construct_regions
                    ...
                    res['lmjgp'] = [rmse, mean_crps, run_time]
                    lmjgp_res.append({'m1': m1, 'm2': m2, 'rmse': rmse, 'mean_crps': mean_crps, 'run_time': run_time, 'n': n, 'batch_size': batch_size, 'lr': lr, 'K': K})
